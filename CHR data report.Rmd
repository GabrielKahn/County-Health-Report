...
While overall New York State has a high Nutrition Inndex at around 8.75, most counties fall short of this measure. Since the state mean is so much higher than the median county index, this hints that the counties whose values lie higher may have large populations which give them greater pull. Five counties have values higher than the mean, Nassau, Suffolk, Putnam, Westchester, and Richmond. Geographically, these counties closely border New York City, which may indicate higher levels of wealth.
